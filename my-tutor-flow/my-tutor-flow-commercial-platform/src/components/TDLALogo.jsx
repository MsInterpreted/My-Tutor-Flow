...
// Logo Option 2: Modern Green & Teal (Education Growth)
export const TDLALogo2 = ({ size = 120, showText = true }) => (
  <Box display="flex" flexDirection="column" alignItems="center">
    <svg width={size} height={size * 0.8} viewBox="0 0 120 96" fill="none">
      ...
      {/* Sleek Graduation Cap */}
      <g filter="url(#shadow2)">
        {/* Cap Base - Modern 3D */}
        <ellipse cx="60" cy="45" rx="42" ry="6" fill="#004D40" opacity="0.8" />
        <ellipse cx="60" cy="43" rx="42" ry="6" fill="url(#capGrad2)" />

        {/* Cap Top - Sleek Design */}
        <rect x="18" y="30" width="84" height="8" rx="4" fill="url(#capGrad2)" />
        <rect x="15" y="27" width="90" height="8" rx="4" fill="#4DB6AC" opacity="0.9" />

        {/* Prominent Tassel */}
        <circle cx="88" cy="27" r="4" fill="url(#tasselGrad2)" />
        <rect x="86" y="31" width="4" height="2" rx="2" fill="url(#tasselGrad2)" />

        {/* Multiple Tassel Strands */}
        <g stroke="url(#tasselGrad2)" strokeWidth="1.5" strokeLinecap="round">
          <line x1="86" y1="33" x2="94" y2="48" />
          <line x1="88" y1="33" x2="96" y2="48" />
          <line x1="90" y1="33" x2="98" y2="48" />
          <line x1="92" y1="33" x2="100" y2="48" />
        ...
        {/* Tassel End */}
        <ellipse cx="97" cy="48" rx="3" ry="2" fill="url(#tasselGrad2)" />
      </g>
